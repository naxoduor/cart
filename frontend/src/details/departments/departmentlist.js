...
class DepartmentList extends Component {
    ...
    getSearchProducts = (event) => {
        ...
        let searchurl = "http://localhost:8080/products/search"
    ...
    getDepartmentCategories(id) {
        let categoriesurl = "http://localhost:8080/categories/inDepartment/?id=" + id;
        this.props.fetchCategoriesByDepartment(categoriesurl, id)
    }

    getDepartmentProducts(id) {
        let productsurl = "http://localhost:8080/products/inDepartment/?id=" + id;
        this.props.fetchProductsByDepartment(productsurl, id)
    }

    getDepartmentTotalItems(id) {
        let totalitemsurl = "http://localhost:8080/departments/totalitems/?id=" + id;
    ...
    getCategoryProducts = (event, id) => {
        ...
        let productsurl = "http://localhost:8080/products/inCategory/?id=" + id;
        let totalitemsurl = "http://localhost:8080/categories/totalitems/?id=" + id;
    ...
    render() {
        ...
        const departments = this.props.departments && this.props.departments.items && this.props.departments.items.map(department => (
        ...
        if (this.props.categories) {
            renderCategories = this.props.categories && this.props.categories.items && this.props.categories.items.map(category => (
